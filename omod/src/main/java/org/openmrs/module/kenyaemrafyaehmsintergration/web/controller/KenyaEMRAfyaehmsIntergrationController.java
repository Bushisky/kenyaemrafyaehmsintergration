 ...
 */
package org.openmrs.module.kenyaemrafyaehmsintergration.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.KenyaEMRAfyaehmsIntergrationController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class KenyaEMRAfyaehmsIntergrationController {
